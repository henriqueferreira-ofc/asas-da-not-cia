...
export function PrivacidadeFormFields({ content, onChange }: Props) {
  ...
  return (
    <div className="space-y-6">
      <div className="grid gap-4">
        ...
        <div>
          ...
          <Input
            ...
            placeholder="Saiba como coletamos, usamos e protegemos suas informações pessoais."
          />
        </div>
      </div>
      ...
      <div>
        <Label>1. Informações que Coletamos</Label>
        <Textarea
          rows={4}
      ...
      <div>
        <Label>2. Como Usamos suas Informações</Label>
        <Textarea
          rows={4}
      ...
      <div>
        <Label>3. Compartilhamento de Dados</Label>
        <Textarea
          rows={4}
      ...
      <div>
        <Label>4. Segurança dos Dados</Label>
        <Textarea
          rows={4}
      ...
      <div>
        <Label>6. Seus Direitos (LGPD)</Label>
        <Textarea
          rows={4}
      ...
      <div>
        <Label>7. Alterações nesta Política</Label>
        <Textarea
          rows={3}
