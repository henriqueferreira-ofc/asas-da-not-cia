...
import { prefetchAjudeNos } from "@/App";
    ...
    return (
      <div className="min-h-screen bg-background">
        ...
        <main className="container py-16 text-center">
          ...
          <PrefetchLink to="/ajude-nos#ebooks" prefetch={prefetchAjudeNos} className="text-primary hover:underline">Voltar para E-Books</PrefetchLink>
        </main>
        <Footer />
      </div>
    );
